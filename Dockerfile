...
RUN R --vanilla -e 'ts <- learnr::available_tutorials("tutorial.helpers"); if (!("tutorials" %in% ts$name)) stop("tutorials tutorial not found"); cat("TUTORIALS OK:", paste(ts$name, collapse = ", "), "\n")'
# ─────────────────────────────────────────────────────────────────────────────
